...
[![godoc](http://img.shields.io/badge/godoc-reference-blue.svg?style=flat)](https://godoc.org/github.com/rhinonet/zerolog) [![license](http://img.shields.io/badge/license-MIT-red.svg?style=flat)](https://raw.githubusercontent.com/rhinonet/zerolog/master/LICENSE) [![Build Status](https://github.com/rhinonet/zerolog/actions/workflows/test.yml/badge.svg)](https://github.com/rhinonet/zerolog/actions/workflows/test.yml) [![Go Coverage](https://github.com/rhinonet/zerolog/wiki/coverage.svg)](https://raw.githack.com/wiki/rhinonet/zerolog/coverage.html)
...
Find out [who uses zerolog](https://github.com/rhinonet/zerolog/wiki/Who-uses-zerolog) and add your company / project to the list.
...
```bash
go get -u github.com/rhinonet/zerolog/log
```
...
For simple logging, import the global logger package **github.com/rhinonet/zerolog/log**
...
import (
    ...
    "github.com/rhinonet/zerolog/log"
)
...
The `github.com/rhinonet/zerolog/hlog` package provides some helpers to integrate zerolog with `http.Handler`.
